...
```bash
$ helm install --name my-release ./tomcat
```
...
------------------------------- | ------------------------------------- | ----------------------------------------------------------
`image.sample.repository`       | Sidecar image source repository name  | `172.16.9.49/sample`
`image.sample.tag`              | `sample` release tag.                 | `latest`
`image.tomcat.repository`       | Tomact image source repository name   | `tomcat`
`image.tomcat.tag`              | `tomcat` release tag.                 | `9-jdk8-openjdk-slim`
...
`service.externalPort`          | Kubernetes service port               | `81`
